...
class TestWorldModelBiometricRouting:
    ...
    def test_spo2_update(self, world_model):
        ...
        world_model.update_from_mqtt(
            "hems/personal/biometrics/garmin/spo2",
            {
                "percent": 98,
            },
        )
    ...
    def test_sleep_data_update(self, world_model):
        ...
        world_model.update_from_mqtt(
            "hems/personal/biometrics/garmin/sleep",
            {
                "stage": "deep",
    ...
    def test_activity_data_update(self, world_model):
        ...
        world_model.update_from_mqtt(
            "hems/personal/biometrics/garmin/activity",
            {
                "steps": 5000,
                "steps_goal": 10000,
                "calories": 250,
    ...
    def test_stress_data_update(self, world_model):
        ...
        world_model.update_from_mqtt(
            "hems/personal/biometrics/garmin/stress",
            {
                "level": 45,
            },
        )
    ...
    def test_fatigue_data_update(self, world_model):
        ...
        world_model.update_from_mqtt(
            "hems/personal/biometrics/garmin/fatigue",
            {
                "score": 35,
                "factors": ["high_hr"],
            },
    ...
    def test_steps_alternative_topic(self, world_model):
        ...
        world_model.update_from_mqtt(
            "hems/personal/biometrics/garmin/steps",
            {
                "count": 5000,
                "daily_goal": 10000,
            },
