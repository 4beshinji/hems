...
class TestWorldModelServiceEvents:
    ...
    def test_events_ring_buffer(self, world_model):
        for i in range(25):
            world_model.services_state.add_event(Event(event_type="test", description=f"event_{i}"))
