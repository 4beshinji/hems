...
# MicroPython driver for BME680 air quality sensor, based on Adafruit_bme680
...
class BME680:
    ...
    def temperature(self):
        ...
        return (((self._t_fine * 5) + 128) / 256) / 100
    ...
    def humidity(self):
        ...
        var2 = (self._humidity_calibration[1] * (((temp_scaled * self._humidity_calibration[3]) / 100) + (((temp_scaled * ((temp_scaled * self._humidity_calibration[4]) / 100)) / 64) / 100) + 16384)) / 1024
        var3 = var1 * var2
