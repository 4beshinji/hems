...
import { LayoutDashboard, Monitor, Heart, Volume2, VolumeX, Sun, Moon, Gauge, User, Mic, MicOff, Zap, LogOut, Play, Cpu, Smartphone, ShieldCheck, SlidersHorizontal } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/settings/thresholds', icon: SlidersHorizontal, label: 'Thresholds' },
] as const
