...
- Mobile P1.3b boundary: Backend now emits canonical `hems/personal/mobile/mobile.{id}/{kind}` through a durable worker. Brain reducer and observation side-effect dedup are still unchanged and remain P1.3c work.
