...
Status: Phase 0、Phase 1 P1.1/P1.2a/P1.2b/P1.3a/P1.3b implemented (2026-07-19)、P1.3c–P1.5 proposed。2026-07-25 に PostgreSQL migration を再検証し revision ID を正規化。入力は同日4監査。過剰設計を避け、既存FastAPI / SQLite / MQTT / PostgreSQLを維持する。
...
P1.3aのBackend migration file `0004_mobile_observation_foundation.py`（revision ID `0004_mobile_observation`）はmobile deviceを`RESTRICT`参照するimmutable inboxと、
