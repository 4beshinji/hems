...
| P0.3b legacy bootstrap / reconciliation | Done | this commit | SQLite focused pytest 7 passed。empty/full/partial→head、sentinel/未知schema保持、二度目no-op、missing baseline/type/unknown revision fatal |
