...
> **HISTORICAL / CLOSED 2026-05-03**: 全項目が [`wiring-gap-06-data-flow-consolidation.md`](wiring-gap-06-data-flow-consolidation.md) に統合・解消済み (Wave 2 で vlm_history context 露出、anomaly 3 段階 escalation、新 perception tool 群を実装)。
