...
def seed(base: str, key: str):
    ...
    post(
        "/home/snapshot",
        {
            "lights": [
                ...
                {"entity_id": "light.bedroom", "name": "寝室照明", "state": "off", "brightness": 0},
                {
            ...
            "covers": [
                {"entity_id": "cover.living_room", "name": "リビング カーテン", "state": "open", "position": 100},
                {"entity_id": "cover.bedroom", "name": "寝室 カーテン", "state": "closed", "position": 0},
            ],
            "sensors": [
                {"entity_id": "sensor.power_consumption", "name": "消費電力", "state": "450", "unit": "W"},
            ],
            "bridge_connected": True,
            "last_update": now,
        },
    ...
    tasks = [
        {
            "title": "CO2 濃度が上昇 — 換気を推奨",
            "description": "リビングの CO2 が 620ppm。窓を開けて換気してください。",
            "zone": "living_room",
            "urgency": 2,
        ...
        {
            "title": "長時間座位を検知 — 休憩推奨",
            "description": "2時間以上座り続けています。軽いストレッチを推奨します。",
            "zone": "living_room",
            "urgency": 3,
            "task_type": ["health"],
        },
        {
            "title": "GitHub PR レビュー 5件",
            "description": "未読の Pull Request レビューリクエストがあります。",
            "zone": None,
            "urgency": 1,
            "task_type": ["digital"],
        },
        {
            "title": "牛乳を買う",
            "description": "買い物リストに牛乳が追加されました。帰宅時に購入を推奨。",
            "zone": None,
            "urgency": 1,
            "task_type": ["shopping"],
        },
        {
            "title": "エアコンフィルター清掃",
            "description": "前回の清掃から 30 日経過。フィルター掃除を推奨します。",
            "zone": "living_room",
            "urgency": 1,
